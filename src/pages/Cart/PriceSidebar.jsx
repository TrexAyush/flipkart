...
const PriceSidebar = ({ cartItems }) => {
    return (
        <div className="sticky flex flex-col top-16 sm:h-screen sm:w-4/12 sm:px-1">

            {/* <!-- nav tiles --> */}
            <div className="flex flex-col bg-white ">
                <h1 className="p-4 font-serif border-b ">Price Details</h1>

                <div className="flex flex-col p-4 pb-3 space-y-1 font-serif text-sm">
