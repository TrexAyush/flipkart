                ...
                <div className="flex-1">
                    ...
                    <Stepper activeStep={2}>
                        ...
                        <div className="flex justify-between items-center mt-4 bg-white px-6 py-3 rounded-b-sm">
                            ...
                            <button onClick={() => { navigate('/process/payment') }} className="bg-orange-600 px-6 py-2 text-white font-medium rounded-sm shadow hover:shadow-lg uppercase">continue</button>
                        </div>
                    </Stepper>
                </div>
