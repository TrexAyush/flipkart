...
const Products = (props) => {
    ...
    return (
        <>
            ...
            {props.home ? "" :<Header title="All Products | Flipkart "/> }
            <MinCategory />
            <main className="w-full">

                {/* <!-- row --> */}
                <div className="flex gap-2 m-auto mt-2 sm:mt-2 sm:mx-3 mb-7">
                    ...
                    <div className="flex-col hidden w-1/5 px-1 sm:flex">
                        ...
                        <div className="flex flex-col bg-white rounded-sm shadow">
                            ...
                            <div className="flex items-center justify-between gap-5 px-4 py-2 border-b">
                                ...
                                <span className="text-xs font-medium uppercase cursor-pointer text-primary-blue" onClick={() => clearFilters()}>clear all</span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2 py-3 overflow-hidden text-sm">
                                ...
                                <div className="flex flex-col gap-2 px-4 border-b">
                                    ...
                                    <div className="flex items-center justify-between min-w-full gap-3 mb-2">
                                        <span className="flex-1 px-4 py-1 text-gray-800 border rounded-sm bg-gray-50">₹{price[0].toLocaleString()}</span>
                                        <span className="font-medium text-gray-400">to</span>
                                        <span className="flex-1 px-4 py-1 text-gray-800 border rounded-sm bg-gray-50">₹{price[1].toLocaleString()}</span>
                                    </div>
                                </div>
                                {/* price slider filter */}
                                ...
                                <div className="flex flex-col px-4 border-b">
                                    ...
                                    <div className="flex items-center justify-between py-2 pb-4 cursor-pointer" onClick={() => setCategoryToggle(!categoryToggle)}>
                                ...
                                <div className="flex flex-col px-4 border-b">
                                    ...
                                    <div className="flex items-center justify-between py-2 pb-4 cursor-pointer" onClick={() => setRatingsToggle(!ratingsToggle)}>
                    ...
                    <div className="flex-1">
                        ...
                        {!loading && products?.length === 0 && (
                            <div className="flex flex-col items-center justify-center gap-3 p-6 bg-white rounded-sm shadow-sm sm:p-16">
                                <img draggable="false" className="object-contain w-1/2 h-44" src="https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/error-no-search-results_2353c5.png" alt="Search Not Found" />
