                ...
                return (
                    <div className="flex items-center gap-2">
                        <div className="w-10 h-10 rounded-full">
                            <img draggable="false" src={params.row.image} alt={params.row.name} className="object-cover w-full h-full rounded-full" />
                        </div>
                        {params.row.name}
                    </div>
                )
            ...
            renderCell: (params) => {
                return (
                    <>
                        {
                            params.row.stock < 10 ? (
                                <span className="flex items-center justify-center w-6 h-6 p-1 font-medium text-red-700 bg-red-200 rounded-full">{params.row.stock}</span>
                            ) : (
    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between">
                ...
                <Link to="/admin/new_product" className="px-4 py-2 font-medium text-white rounded shadow bg-primary-blue hover:shadow-lg">New Product</Link>
            </div>
            <div className="w-full bg-white shadow-lg rounded-xl" style={{ height: 470 }}>
