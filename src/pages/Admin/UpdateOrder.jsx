                ...
                <>
                    {order && order.user && order.shippingInfo && (
                        <div className="flex flex-col gap-4">
                            <Link to="/admin/orders" className="flex items-center gap-0 ml-1 font-medium uppercase text-primary-blue"><ArrowBackIosIcon sx={{ fontSize: "18px" }} />Go Back</Link>
                            ...
                            {order.orderItems && order.orderItems.map((item) => {
                                ...
                                return (
                                    <div className="flex flex-col min-w-full px-2 py-5 bg-white rounded-lg shadow-lg sm:flex-row" key={_id}>
                                        ...
                                        <div className="flex flex-col gap-1 sm:flex-row sm:w-1/2">
                                            ...
                                            <div className="flex flex-col gap-1 overflow-hidden">
                                                ...
                                                <p className="mt-2 text-xs text-gray-600">Quantity: {quantity}</p>
