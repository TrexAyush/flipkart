...
const NewProduct = () => {
    ...
    const newProductSubmitHandler = (e) => {
        ...
        try {
            ...
            Product.set('cuttedPrice',cuttedPrice );
            Product.set("category", category);
            Product.set("stock", stock);
            Product.set("warranty", warranty);
            Product.set("brandname", brand);
            Product.set("logo", logo);

            Product.set("images",images)
            Product.set("highlights",highlights)
            ...
            //     Product.append("highlights", h);
            // });
    
            // specs.forEach((s) => {
            //     Product.append("specifications", JSON.stringify(s));
            // });
            ...
            //   alert('Person saved!');
              ...
              enqueueSnackbar("Product Not SAVED", { variant: "error" });
            }
    ...
    return (
        <>
            <Header title="Add New Product | Flipkart"/>
            ...
            <form onSubmit={newProductSubmitHandler} encType="multipart/form-data" className="flex flex-col p-4 bg-white rounded-lg shadow sm:flex-row" id="mainform">
                ...
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between border rounded">
                            ...
                            <span onClick={() => addHighlight()} className="px-6 py-2 text-white bg-blue-500 rounded-r cursor-pointer hover:shadow-lg">Add</span>
                        </div>

                        <div className="flex flex-col gap-1.5">
                            {highlights.map((h, i) => (
                                <div className="flex items-center justify-between px-2 py-1 bg-green-500 rounded">
                ...
                <div className="flex flex-col gap-2 m-2 sm:w-1/2">
                    ...
                    <div className="flex items-center gap-2 justify-evenly">
                        ...
                        <span onClick={() => addSpecs()} className="px-6 py-2 text-white bg-blue-500 rounded cursor-pointer hover:shadow-lg">Add</span>
                    </div>
                    ...
                    <div className="flex justify-end">
                        <input form="mainform" type="submit" className="w-1/3 p-3 font-medium text-white uppercase bg-orange-500 rounded-md shadow-lg cursor-pointer hover:shadow-lg" value="Submit" />
                    </div>
