    ...
    return (
        <>
            ...
            <div className="flex items-center justify-between gap-2 sm:gap-12">
                ...
                <input type="text" placeholder="Product ID" value={productId} onChange={(e) => setProductId(e.target.value)} className="w-full p-2 border-0 rounded shadow outline-none hover:shadow-lg" />
            </div>
            <div className="w-full bg-white shadow-lg rounded-xl" style={{ height: 450 }}>
