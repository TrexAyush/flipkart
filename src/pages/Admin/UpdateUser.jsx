            ...
            {loading ? <Loading /> : (
                <>
                    <div className="flex flex-col max-w-xl mx-auto bg-white rounded-lg shadow-lg w-lg">
                        <h2 className="mt-6 text-2xl font-medium text-center text-gray-800">Update Profile</h2>
                        ...
                        >
                            <div className="flex flex-col items-start gap-3">
                                ...
                                <button type="submit" className="w-full py-3 font-medium text-white rounded-sm shadow bg-primary-orange hover:shadow-lg">Update</button>
                                <Link className="w-full py-3 font-medium text-center border rounded-sm shadow hover:bg-gray-100 text-primary-blue" to="/admin/users">Cancel</Link>
                            </div>
