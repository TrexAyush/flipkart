            ...
            {loading ? <Loader /> : (
                <>
                    ...
                    <main className="w-full">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    {Array(3).fill("").map((el, i) => (
                                        <p className="text-sm flex items-center gap-1" key={i}>
                                            ...
                                            <span className="font-medium ml-2">Bank Offer</span> 15% Instant discount on first Flipkart Pay Later order of 500 and above <Link className="text-blue-600 font-medium" to="/">T&C</Link>
                                        </p>
                                    ))}
                                    {/* <!-- banks offers --> */}
                                    ...
                                    <div className="w-full mt-6 rounded-sm border flex flex-col">
                                        <h1 className="px-6 py-4 border-b text-xl font-medium">Product Description</h1>
                                        <div className="p-6">
                                    ...
                                    <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col">
                                        <h1 className="px-6 py-4 border-b text-xl font-medium">Specifications</h1>
                                    ...
                                    <div className="w-full mt-4 rounded-sm border flex flex-col">
                                        <div className="flex justify-between items-center border-b px-6 py-4">
                                            ...
                                            <button onClick={handleDialogClose} className="shadow bg-yellow-500 text-white px-4 py-2 rounded-sm hover:shadow-lg">Rate Product</button>
                                        </div>
                        ...
                        <div className="w-full sticky bottom-0 z-10 flex text-sm font-serif">
                            {/* <!-- add to cart btn --> */}
                            {product.stock > 0 && (
                                <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-2 w-1/2 flex items-center justify-center gap-2 text-black bg-white rounded-sm shadow hover:shadow-lg">
                                    <ShoppingCartIcon />
